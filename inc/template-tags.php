...
function mdlwp_posts_navigation() {
	...
	<nav class="mdlwp-nav mdl-color-text--grey-50 mdl-cell mdl-cell--12-col" role="navigation">
		...
		<?php previous_posts_link( __( '<button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon mdl-button--colored mdl-button--colored-secondary">
		...
		<?php next_posts_link( __( 'Older
          <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon mdl-button--colored mdl-button--colored-secondary">
...
function mdlwp_post_navigation() {
	...
	<nav class="mdlwp-nav mdl-color-text--grey-50 mdl-cell mdl-cell--12-col" role="navigation">
			<?php
				next_post_link( '%link', '<button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon mdl-button--colored mdl-button--colored-secondary">
            <i class="material-icons">arrow_back</i>
          </button> Newer' );
